...
void can_init(void)
{
	...
	CAN1->sFilterRegister[0].FR1 = (uint32_t)((RX_F0_ID0 << 5) | (RX_F0_ID1 << 21)); 
	CAN1->FA1R |= CAN_FA1R_FACT0;
	...
	CAN1->sFilterRegister[1].FR1 = (uint32_t)((RX_F1_ID0 << 5) | (RX_F1_ID1 << 21)); 
	CAN1->FA1R |= CAN_FA1R_FACT1;
...
void can_start(void)
{
	...
	CAN1->sTxMailBox[0].TDLR = led_init;
